...
let butEnglish = document.querySelector(".butEnglish")
butEnglish.addEventListener("click", function(){
...
const words = ["電腦科學", "人工智慧", "醫療事業", "創業精神", "政府", "教育"];
let i = 0;
let timer;
...
weatherButton.addEventListener("click", function(){ 
    if(weatherBox.style.display != "none"){
        ...
        weatherButton.innerHTML = "下雨 🌧"
    }
    else if(weatherBox.style.display = "none"){
        weatherBox.style.display = "block";
        weatherButton.innerHTML = "太陽 🔆"
    }
    else{
